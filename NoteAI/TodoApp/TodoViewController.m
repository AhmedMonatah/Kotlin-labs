...
- (void)setupHeader {
    ...
    self.searchBar.placeholder = @"Search to-do tasks...";
    ...
    tf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"Search to-do tasks..."
...
- (void)loadData {
    self.tasks = [[TaskManager sharedManager] todoTasks];
    [self applyFilters];
}
